...
namespace Spatial.Benchmarks
{
    ...
    {
        private static readonly Ray3D Ray3D1 = new Ray3D(new Point3D(1, 2, 3), Direction.Create(1, 0, 0));
        private static readonly Ray3D Ray3D2 = new Ray3D(new Point3D(3, 4, 5), Direction.Create(0, 1, 0));
