...
namespace MathNet.Spatial.Tests.Euclidean
{
    ...
    public class UnitVector3DTests
    {
        ...
        {
            var uv = UnitVector3D.Create(0.2672612419124244, -0.53452248382484879, 0.80178372573727319);
            var xml = "<UnitVector3D><X>0.2672612419124244</X><Y>-0.53452248382484879</Y><Z>0.80178372573727319</Z></UnitVector3D>";
        ...
        public void XmlContainerRoundtrip()
        {
            ...
            var expected = "<ContainerOfUnitVector3D><Value1><X>0.2672612419124244</X><Y>-0.53452248382484879</Y><Z>0.80178372573727319</Z></Value1><Value2><X>1</X><Y>0</Y><Z>0</Z></Value2></ContainerOfUnitVector3D>";
        ...
        public void XmlElements()
        {
            ...
            using (var reader = new StringReader("<UnitVector3D><X>0.2672612419124244</X><Y>-0.53452248382484879</Y><Z>0.801783725737273</Z></UnitVector3D>"))
            {
